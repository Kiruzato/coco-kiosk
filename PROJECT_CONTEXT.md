...
•	FastAPI + Uvicorn
•	LangChain
•	OpenAI Chat model (currently gpt-3.5-turbo)
•	OpenAI Embeddings
Retrieval
...
•	Directory answers are deterministic:
Locations come from structured entities, not freeform LLM output.
•	Confidence gating:
o	Campus answers require ≥ MEDIUM confidence.
o	Directory answers require ≥ HIGH confidence.
•	Kiosk UX:
...
•	Entity-backed resolution (no LLM hallucination)
Entity fields
...
•	Disambiguation with numbered choices + two-strike reset
•	CSV import/export via Admin UI
________________________________________
8. Admin & Developer Tools
Admin
•	/admin UI
•	Document upload/delete
•	Entity CRUD + CSV import/export
•	Analytics endpoints:
o	/admin/analytics
