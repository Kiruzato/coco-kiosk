...
•	Unified RAG architecture (Phase 52):
Directory queries follow the same orchestrator pipeline as all other queries. No special-case entity system.
•	Confidence gating:
...
________________________________________
7. Directory System (RAG-Based, Phase 52)
...
•	Phase 8–12: Directory system + entities
•	Phase 13: Conversation memory
•	Phase 14/14.1: Disambiguation + topic change handling
...
•	Phase 52: Directory Entity → RAG Migration (removed entity system, unified orchestrator flow)
...
o	Section-based routing with URL hash support (#analytics, #upload, #documents, #entities, #voice)
...
Directory System: Unified RAG (Phase 52 - entity system removed)
